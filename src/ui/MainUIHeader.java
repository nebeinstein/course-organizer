...
public class MainUIHeader extends JFrame {
	...
	static String[] deps = { "--- Select one ---", " - Accounting",
			...
			" - Art", " - Bioinformatics & Computnl Biol",
			"BB - Biology and Biotechnology", "BME - Biomedical Engineering",
			" - Business", "CHE - Chemical Engineering", "CH - Chemistry",
			" - Chinese", " - Civil Engineering", "CS - Computer Science",
			" - Data Science", " - Economics",
			"ECE - Electrical and Computer Engineering",
			"ES - Engineering Science", " - English", " - Entrepreneurship",
			"ENV - Environmental Studies", " - Finance",
			"FPE - FIre Protection", " - German",
			"GOV - Government, Politcl Sci, & Law", "HI - History",
			"HU - Humanities & Arts", "MA - Mathematic Sciences", "MU - Music",
			"PE - Physical Education", "PH - Physics",
			"RBE - Robotics Engineering" };
	static String[] years = { "--- Select one ---", "2012-2013", "2013-2014",
			"2014-2015", "2015-2016" };
